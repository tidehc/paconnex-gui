...
<body onload="<?php echo $onload;?>">
	...
	if (!$default_login) {
					...
					<div class="navbar-header">
						...
						if ($menu_brand) {
							...
							//define menu brand mark
								$menu_brand_text = ($_SESSION['theme']['menu_brand_text']['text'] != '') ? $_SESSION['theme']['menu_brand_text']['text'] : "PA ConneX";
		...
		//determine menu configuration
			...
			<div id='footer'>
				<span class='footer'><?php echo (isset($_SESSION['theme']['footer']['text'])) ? $_SESSION['theme']['footer']['text'] : "&copy; ".$text['theme-label-copyright']." 2008 - ".date("Y")." <a href='http://admin.paconnex.com' class='footer' target='_blank'>admin.paconnex.com</a> ".$text['theme-label-all_rights_reserved']; ?></span>
			</div>
		</div>
	...
	// default login being used
		...
		<div id='footer_login'>
			<span class='footer'><?php echo (isset($_SESSION['theme']['footer']['text'])) ? $_SESSION['theme']['footer']['text'] : "&copy; ".$text['theme-label-copyright']." 2017 - ".date("Y")." <a href='http://admin.paconnex.com' class='footer' target='_blank'>admin.paconnex.com</a> ".$text['theme-label-all_rights_reserved']; ?></span>
		</div>
		<?php
