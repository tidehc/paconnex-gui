...
$text['description-upgrade_source']['en-us'] = "Updates PA conneX source files from the PA respository.";
$text['description-upgrade_source']['ar-eg'] = "";
$text['description-upgrade_source']['de-at'] = "Aktualisiert den PA conneX Quellcode aus dem Repository"; //copied from de-de
$text['description-upgrade_source']['de-ch'] = "Aktualisiert den PA conneX Quellcode aus dem Repository"; //copied from de-de
$text['description-upgrade_source']['de-de'] = "Aktualisiert den PA conneX Quellcode aus dem Repository";
$text['description-upgrade_source']['es-cl'] = "Archivos de origen Actualizaciones PA conneX del repositorio.";
$text['description-upgrade_source']['es-mx'] = "Archivos de origen Actualizaciones PA conneX del repositorio."; //copied from es-cl
$text['description-upgrade_source']['fr-ca'] = "Mise à jour du code source de PA conneX depuis le dépôt."; //copied from fr-fr
$text['description-upgrade_source']['fr-fr'] = "Mise à jour du code source de PA conneX depuis le dépôt.";
$text['description-upgrade_source']['he-il'] = "";
$text['description-upgrade_source']['it-it'] = "Aggiorna il files sorgente di PA conneX dal repository.";
$text['description-upgrade_source']['nl-nl'] = "";
$text['description-upgrade_source']['pl-pl'] = "Uaktualnia pliki źródłowe PA conneX z przechowalni.";
$text['description-upgrade_source']['pt-br'] = "Arquivos de atualização";
$text['description-upgrade_source']['pt-pt'] = "Arquivos de origem Atualizações PA conneX do repositório.";
$text['description-upgrade_source']['ro-ro'] = "";
$text['description-upgrade_source']['ru-ru'] = "Обновляет исходные файлы PA conneX из репозитория.";
$text['description-upgrade_source']['sv-se'] = "Uppdaterar PA conneX källfiler från respository.";
$text['description-upgrade_source']['uk-ua'] = "Оновлення вихідних файлів  PA conneX з репозиторію Subversion .";
